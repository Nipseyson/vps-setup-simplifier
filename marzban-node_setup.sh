...
echo -e "\n🔧 SSH порт: ${ssh_port}."
echo -e "\n🔧 Порт для marzban-node: ${marz_port}."
echo -e "\n🔧 Порт для xray API: ${api_port}."
echo -e "\n🔧 Основной домен: ${main_domain}."
echo -e "\n🔧 Суб-домен панели: ${panel_domain}."
echo -e "\n🔧 Суб-домен подписок: ${sub_domain}."
echo -e "\n🔧 Маскировочный домен: ${xray_reality_domain}."
